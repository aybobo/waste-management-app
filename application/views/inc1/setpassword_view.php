                    ...
                    <div class="col-xl-7 pa-0">
                        ...
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                ...
                                <?php echo form_open('Admin/newpassword', ['class' => 'form-signin']); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form-control" name="confirm-pwd" placeholder="Confirm Password" type="password">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><span class="feather-icon"><i data-feather="eye-off"></i></span></span>
                                            </div>
                                        </div>
                                    ...
                                    <button class="btn btn-success btn-block" type="submit">Set Password</button>
                                    <p class="font-14 text-center mt-15"><a href="<?=site_url('admin/index')?>" class="forgot-password">Login</a></p>
