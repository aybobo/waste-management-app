        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">All Agents</h2>
                                                ...
                                                <tbody>
                                                    <?php foreach ($agents as $record) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <?php echo $record->telno; ?>
                                                            </td>
                                                            <td>
                                                               <?php echo $record->sectorname; ?> 
                                                            </td>
                                                            <td>
                                                                <?php echo $record->status; ?>
                                                            </td>
                                                            <td>
                                                            <?php $var = $record->agentid; ?>
                                                            <a href="<?=base_url()?>customersetup/editagent/?id=<?php echo $var; ?>" class="label label-primary"><span class="glyphicon glyphicon-pencil"></span></a>
                                                          </td>
                                                        </tr>
                                                   <?php } ?>
                                                </tbody>
