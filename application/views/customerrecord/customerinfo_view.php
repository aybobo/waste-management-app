        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">Customer Information</h2>
                                ...
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <!--<div class="table-responsive">-->
                                            <table id="datable_1" class="table table-hover table-bordered mb-0">
                                                ...
                                                <tbody>
                                                    <?php foreach ($rows as $row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                $name = $row->title . ' ' . $row->fname . ' ' . $row->oname . ' ' . $row->lname;
                                                            echo $name;
                                                                ?>
                                                            </td>
                                                            <td>
                                                                <?php
                                                                $add = $row->houseno . ', ' . $row->streetname . '@' . $row->sectorname;
                                                            echo $add;
                                                                ?>
                                                            </td>
                                                            <td><?php echo $row->telno; ?></td>
                                                            <td>
                                                                <?php echo $row->housecat; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $row->status; ?>
                                                            </td>
