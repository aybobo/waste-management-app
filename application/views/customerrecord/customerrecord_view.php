        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">Customer Records</h2>
        ...
        <div class="col-md-12">
            <!-- Nav tabs -->
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#home">Location</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#menu1">Agent</a>
                </li>
              </ul>
              ...
              <div class="tab-content">
                <div id="home" class="container tab-pane active"><br>
                  <h5 class="mb-10">View Customers By Location</h5>
                  <div class="row">
                      <div class="col-sm-12">
                        <?php echo form_open('invoicereceipt/customerbylocation', 
                                    ['class' => 'form-inline']); ?>
                ...
                <div id="menu1" class="container tab-pane fade"><br>
                  <h5 class="mb-10">View Customers By Agents</h5>
                    <div class="row">
                      <div class="col-sm-12">
                          <?php echo form_open('invoicereceipt/customerbyagent', 
                                    ['class' => 'form-inline']); ?>
                            <div class="form-row align-items-center">
                                <div class="col-auto">
