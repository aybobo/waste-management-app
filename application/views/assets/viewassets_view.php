        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">All Assets</h2>
                                                ...
                                                <tbody>
                                                    <?php foreach ($records as $record) {
                                                        ...
                                                        <tr>
                                                            <td><?php echo $i; ?></td>
                                                            <td>
                                                                <a href="<?=base_url()?>assets/assetexpense/?id=<?php echo $record->assetid; ?>"><?php
                                                                  echo $record->assetname;
                                                                ?></a>
                                                            </td>
                                                            <td>
                                                                <?php
                                                            ...
                                                            <td>
                                                                <?php
                                                            echo $record->purchasedate;
                                                                ?>
                                                            </td>
                                                            <td><?php echo $record->status; ?></td>
                                                            <td>
                                                            <?php $var = $record->assetid; ?>
                                                            <a href="<?=base_url()?>assets/editasset/?id=<?php echo $var; ?>" class="label label-primary"><span class="glyphicon glyphicon-pencil"></span></a>
                                                          </td>
                                                        </tr>
                                                   <?php } ?>
                                                </tbody>
