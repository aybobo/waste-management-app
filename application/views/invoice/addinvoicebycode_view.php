        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h3 class="hk-pg-title font-weight-600 mb-10">Generate Invoice(Customer Code)</h3>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<?php echo form_open('customersetup/getinvoicebycustomercode', 
                                ...
                                <!--<form class="form-horizontal" method="post" action="#">-->
                                    ...
                                    <div class="form-group">
                                        <label for="code" class="cols-sm-2 control-label">Customer Code<sup class="text-red">*</sup></label>
                                        <small><?php echo form_error('code', '<div class="text-danger">', '</div>'); ?></small>
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                                </div>
                                                <input type="text" class="form-control" name="code" id="code" placeholder="Enter customer code" value="<?php echo (isset($_POST['code']) ? $_POST['code'] : ''); ?>" />
                                            </div>
                                        </div>
                                    </div>
