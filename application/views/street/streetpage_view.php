        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">Street Setup</h2>
...
<!-- here ----->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">Add Street</div>
                            <div class="card-body">
                            	<?php echo form_open('customersetup/addstreet', 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" readonly="true" name="street" id="street" placeholder="Enter street name" value="<?php echo (isset($_POST['street']) ? $_POST['street'] : ''); ?>"/>
                                            </div>
                                        </div>
                                    </div>
