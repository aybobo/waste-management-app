        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">Update Street</h2>
...
<!-- here ----->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<?php echo form_open('customersetup/updatestreet', 
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <select class="form-control custom-select" name="sector" onchange="mySector()" id="sector">
                                                    <option value="<?php echo $street->sectorid; ?>" selected><?php echo $street->sectorname; ?></option>
                                                    <?php 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="street" id="street" value="<?php echo (isset($_POST['street']) ? $_POST['street'] : $street->streetname); ?>"/>
                                            </div>
                                        </div>
                                    </div>
          ...
          <input type="hidden" id="ostrname" name="ostrname" value="<?php echo $street->streetname; ?>">
        <input type="hidden" id="id" name="id" value="<?php echo $street->streetid; ?>">
