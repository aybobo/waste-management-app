        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">All Sector Areas</h2>
                                                ...
                                                <tbody>
                                                    <?php foreach ($records as $record) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <?php $var = $record->areaid; ?>
                                                            <a href="<?=base_url()?>customersetup/editarea/?id=<?php echo $var; ?>" class="label label-primary"><span class="glyphicon glyphicon-pencil"></span></a>
                                                          </td>
                                                        </tr>
                                                   <?php } ?>
                                                </tbody>
