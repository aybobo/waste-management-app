        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">Confirm Payment</h2>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<?php echo form_open('customersetup/savepayment', 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="sector" id="sector" readonly="true" value="<?php echo $data['sectorname']; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="street" id="street" readonly="true" value="<?php echo $data['streetname'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="houseno" id="houseno" readonly="true" value="<?php echo $data['house'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="code" id="code" readonly="true" value="<?php echo $data['customercode'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="customer" id="customer" readonly="true" value="<?php echo $data['customername'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="amount" class="cols-sm-2 control-label">Amount<sup class="text-red">*</sup></label><small><?php echo form_error('amount', '<div class="text-danger">', '</div>'); ?></small>
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fa fa-file fa" aria-hidden="true"></i></span>
                                                </div>
                                                <input type="text" class="form-control" name="amount" id="amount" readonly="true" value="<?php echo $data['amount'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" name="paymentdate" value="<?php echo $data['paymentdate']; ?>" readonly="true" autocomplete="off" class="form-control" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="desc" id="desc" readonly="true" value="<?php echo $data['desc'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!--<div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="paymode" id="paymode" readonly="true" value="<?php echo $data['paymode'] ?>"/>
                                            </div>
                                        </div>
                                    </div>-->

                                    <input type="hidden" id="id" name="id" value="<?php echo $data['customerid']; ?>">
                                    <input type="hidden" name="mnt" value="<?php echo $data['months']; ?>">
