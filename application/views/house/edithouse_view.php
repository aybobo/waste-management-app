        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">Update House</h2>
...
<!-- here ----->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">Edit House</div>
                            <div class="card-body">
                            	<?php echo form_open('customersetup/updatehouse', 
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <option value="<?php echo $house->sectorid; ?>" selected><?php echo $house->sectorname; ?></option>
                                                    <?php 
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <select class="form-control custom-select" name="street" id="street" onchange="housestreet()">
                                                    <option value="<?php echo $house->streetid; ?>" selected><?php echo $house->streetname; ?></option>
                                                    <?php 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="houseno" id="houseno" readonly="true" value="<?php echo (isset($_POST['houseno']) ? $_POST['houseno'] : $house->houseno); ?>"/>
                                            </div>
                                        </div>
                                    </div>
          ...
          <input type="hidden" id="oldname" name="oldname" value="<?php echo $house->houseno; ?>">
          <input type="hidden" id="id" name="id" value="<?php echo $house->houseid; ?>">
