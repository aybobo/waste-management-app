        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">All Houses</h2>
                                                ...
                                                <tbody>
                                                    <?php foreach ($houses as $house) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                            echo $house->createdby;
                                                                ?>       
                                                            </td>
                                                            <td>
                                                                <?php echo date('M j, Y h:ia', strtotime($house->datecreated)); ?>
                                                            </td>
                                                            <td>
                                                               <?php echo $house->modifiedby; ?> 
                                                            </td>
                                                            <td>
                                                                <?php echo date('M j, Y h:ia', strtotime($house->datemodified)); ?>
                                                            </td>
                                                            <td>
                                                            <?php $var = $house->houseid; ?>
                                                            <a href="<?=base_url()?>customersetup/edithouse/?id=<?php echo $var; ?>" class="label label-primary"><span class="glyphicon glyphicon-pencil"></span></a>
                                                          </td>
                                                        </tr>
                                                   <?php } ?>
                                                </tbody>
