            ...
            <!-- Nav tabs -->
              ...
              <div class="tab-content">
                <div id="home" class="container tab-pane active"><br>
                  <h5 class="mb-10">Monthly breakdown of commissions</h5>
                  <div class="row">
                      <div class="col-sm-12">
                        <?php echo form_open('reports/fetchcommissions', 
                                    ['class' => 'form-inline']); ?>
                          <!--<form class="form-inline">-->
                            <div class="form-row align-items-center">
                                <div class="col-auto">
                                    <select class="form-control custom-select" name="agent" id="agent">
                ...
                <div id="menu1" class="container tab-pane fade"><br>
                  <h5 class="mb-10">Payments by date</h5>
                    <div class="row">
                      <div class="col-sm-12">
                          <?php echo form_open('reports/commissionsbydate', 
                                    ['class' => 'form-inline']); ?>
                            <div class="form-row align-items-center">
