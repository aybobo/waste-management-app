        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h4 class="hk-pg-title font-weight-600 mb-10">Debt Analysis of Commercial<br>Debtors Per Sector</h4>
...
<!-- here ----->
    ...
    <!-- Row -->
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($sectordebt as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?=base_url()?>reports/commercialdebtpersector/?sector=<?php echo $key; ?>" class="label label-primary" target="_blank"><span class="glyphicon glyphicon-zoom-in"></span></a>
                                              </td>
                                            </tr>
                                       <?php } ?>
                                    </tbody>
                ...
                <div class="row mt-50">
                    <div class="col-md-12">
                        <a href="<?=site_url('reports/allcommercialdebts')?>" target="_blank" class="btn btn-success">All Commercial Debtors</a>
                    </div>
                </div>
                <!-- --->
                <div class="row">
