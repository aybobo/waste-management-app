                    ...
                    <div>
                        ...
                        $address = ''; $check = '';
                            foreach ($customers as $row) {
                                if ($row->houseno == $check) {
                                    break;
                                }
                                else {
                                    $address .= $row->houseno . ',<br>' . $row->streetname . ', ' . $row->areaname;
                                    $check = $row->houseno;
                                }
                            }
                        ?>
						<h4 class="hk-pg-title font-weight-600 mb-10">Debt Analysis of Residential Customers<br> at <?php echo $address; ?></h4>
