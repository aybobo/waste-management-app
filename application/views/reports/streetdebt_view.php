        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h4 class="hk-pg-title font-weight-600 mb-10">Debt Analysis of Streets in <?php echo $sector; ?></h4>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($streetdebt as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?=base_url()?>customersetup/streetDebtPerHouse/?street=<?php echo $key; ?>&sector=<?php echo $sector; ?>" class="label label-primary" target="_blank"><span class="glyphicon glyphicon-zoom-in"></span></a>
                                              </td>
                                            </tr>
                                       <?php } ?>
                                    </tbody>
