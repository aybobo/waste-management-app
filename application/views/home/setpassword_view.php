        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
                <div class="card card-container">
                    <h4 class="ctr-msg">Set Password</h4>
                    ...
                    <!--<form class="form-signin">-->
                     <?php echo form_open('Admin/newpassword', ['class' => 'form-signin']); ?>
                        ...
                        <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Set Password</button>
                     <?php echo form_close(); ?>
                    <!--</form>/form -->
                    <a href="<?=site_url('admin/index')?>" class="forgot-password">
                        Login
                    </a>
                </div><!-- /card-container -->
                <!-- -->
