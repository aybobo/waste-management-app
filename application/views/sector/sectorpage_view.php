        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">Sector Setup</h2>
...
<!-- here ----->
                ...
                <!--<div class="row">
                    <a href="<?=site_url('customersetup/loadcode')?>">Load Customer Codes</a>
                </div>

                <div class="row">
                    <a href="<?=site_url('customersetup/streetcode')?>">Street Code</a>
                </div>

                <div class="row">
                    <a href="<?=site_url('customersetup/upinvoice')?>">Invoice</a>
                </div>-->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<?php echo form_open('customersetup/addsector', 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="sector" id="sector" placeholder="Enter sector name" value="<?php echo (isset($_POST['sector']) ? $_POST['sector'] : ''); ?>"/>
                                            </div>
                                        </div>
                                    </div>
