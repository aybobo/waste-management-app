                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<?php echo form_open('assets/saveexpense', 
                        			['class' => 'form_horizontal']); ?>
                                
                                    <div class="form-group">
                                        <label for="asset" class="cols-sm-2 control-label">Asset<sup class="text-red">*</sup></label><small><?php echo form_error('asset', '<div class="text-danger">', '</div>'); ?></small>
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fa fa-file fa" aria-hidden="true"></i></span>
                                                </div>
                                                <input type="text" class="form-control" name="asset" id="asset" readonly="true" value="<?php echo $asset; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="misc" id="misc" readonly="true" placeholder="Other means, explain" value="<?php echo $data['misc'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="desc" id="desc" readonly="true" placeholder="Other means, explain" value="<?php echo $data['desc'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="amt" id="amt" readonly="true" value="<?php echo $data['amt'] ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" name="expensedate" value="<?php echo $data['expensedate']; ?>" readonly="true" autocomplete="off" class="form-control" />
                                                
                                            </div>
                                        </div>
                                    </div>

                                    <input type="hidden" id="id" name="id" value="<?php echo $data['asset']; ?>">
